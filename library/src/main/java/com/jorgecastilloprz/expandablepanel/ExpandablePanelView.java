...
public class ExpandablePanelView extends RelativeLayout {
    ...
    private static final int DEFAULT_TOUCH_VIEW_ID = -2;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            touchViewId=a.getResourceId(R.styleable.ExpandablePanelView_touchViewId,DEFAULT_TOUCH_VIEW_ID);
            a.recycle();
        }
    ...
    private void assignTouchView() {
        if (touchViewId != DEFAULT_TOUCH_VIEW_ID) {
            touchView = findViewById(touchViewId);
        }
    }
 ...
 /*   @Override
    ...
    */
    private void setTouchListenerOnView(){
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                switch (motionEvent.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        int fix=0;
                        if(expanded){
                            fix=380; //fix touch response delay for callapse motion
                        }
                        int currentY = (int) motionEvent.getRawY()+fix;
